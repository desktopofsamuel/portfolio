...
## Dec 31,2020
Massive refactoring and organising existing repository. Switching components to Typescript in slow progress.
...
- CHANGED new footer with newsletter subscription and more page naivgations and added Scroll to Top button

## Oct 22, 2020
- CHANGED Unified boxed width across all main pages
- CHANGED blog title font style with case study using Clearendon URW, updated layout
