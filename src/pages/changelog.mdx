...
## Jan 31, 2021
Added brand new series of pages about UX design career, my setup and apps I use!
- ADDED [Tools & Resources](/tools-and-resources) page as main hub of my curated resources and design tools
- ADDED Check out my list of apps and service that I love on [Apps & Services](/apps) page, using [`gatsby-source-airtable`](https://github.com/jbolda/gatsby-source-airtable)
- ADDED Brand new [UX Design Career Kit](/ux-design-career-kit) is here to help you to land your UX job!
- CHANGED New [Landing page](/) with refactored components and layout
- CHANGED New newsletter signup, [sign up now](http://desktopofsamuel.substack.com/) and receive my monthly update!


## Jan 2,2021
Massive refactoring and re-organising existing repository. Switching components to Typescript.
- CHANGED Nav Bar's padding to the top of the page
- CHANGED Font style consistency in the website
- ADDED a Scroll-tracking Table of Content for blog post ([Learn how to make one for your Gatsby website](https://desktopofsamuel.com/how-to-create-a-scroll-tracking-table-of-content-in-gatsby))
