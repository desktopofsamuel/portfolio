...
<Stack>
<ButtonPill text="What I Use" to="/setup" target="_self" isOutline/>
<ButtonPill text="Apps & Services" to="/apps" target="_self" isOutline/>
<ButtonPill text="UX Design Career Kit" to="/ux-design-career-kit" target="_self" isOutline/>
</Stack>
