...
<PageTitle title="My Setup" description="everything" type="secondary" />

<Stack>
<ButtonPill text="What I Use" to="/" target="_self"/>
<ButtonPill text="Apps & Services" to="/apps" target="_self"/>
</Stack>
