...
After few sessions with the client, I have visualised their business idea from concept into design drafts. I have further created wireframes and screenflows to illustrate the user flow. 

![](./FX-Wireframe.png)

In the end, I have delivered UI mockup for development 
