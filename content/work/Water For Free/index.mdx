...
<GridBlock margin="var(--padding-m) 0" gap="2rem">
<Wrapper>
...
![](./w4f-role.svg)
<GridBlock style="text-align: center" min="repeat(auto-fit, minmax(100px, 1fr))">
<Wrapper>
...
In v1, users cannot suggest new dispensers or changes within the app. They are required to report via email or external channels, which hindered the completeness of the database. 

The data source itself is also not maintainable as it was previously maintained on a shared Excel spreadsheet imported manually time to time. 

### Goals for Revamp

**1. Facilitate users hunting water dispensers** —  Making the process as easy and intuitive as possible

**2. Encourage user engagement** — Data was not maintainable as the database is a shared excel spreadsheet imported time to time. 

**3. Reduce workload of the volunteers** — Streamline the workflow and improve the approval process
