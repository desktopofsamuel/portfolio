...
<Alert to="/gatsby-website-with-multiple-post-types">This article was written using Gatsby v1.0. Read my new article for Gatsby v2.0. <strong>Read On →</strong></Alert>
