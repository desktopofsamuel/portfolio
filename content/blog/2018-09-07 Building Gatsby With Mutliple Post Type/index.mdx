...
<Alert
  text="This article was written when I was using Gatsby v1.0. I have written a new one for Gatsby v2.0. Read On →"
  href="/gatsby-website-with-multiple-post-types"
/>
